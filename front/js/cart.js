...
.then(myProducts =>
{
 ...
 function DisplayOfTotalQuantityOfAllProducts()
{

    const quantityOfAllProducts = localStorage.getItem('Produits');
    const conversion = JSON.parse(quantityOfAllProducts);
    const totalQuantity = document.querySelector('#totalQuantity');
      ...
      for (const i of conversion) {
            ...
            // Add up quantity of each product
            total += quantityParse;
            totalQuantity.innerHTML =total;
      }
}
      DisplayOfTotalQuantityOfAllProducts();
